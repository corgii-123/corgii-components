...
describe('upload component work well', () => {
  beforeEach(() => {
    ...
    fileInput = wrapper.container.querySelector('.corgii-file-input') as HTMLInputElement
    uploadArea = wrapper.container.querySelector('.corgii-upload-drag') as HTMLInputElement
  })
